...
## What is pureIINA?
pureIINA is a plugin for the [IINA](https://iina.io/) video player for macOS. It extends IINA's capabilities by providing tools to trim and crop videos directly within the player, and then generate or execute an FFmpeg command to process the video. 
...
- **React Overlay:** Displays a Heads-Up Display (HUD) with real-time video statistics.
...
- [Architecture](Architecture.md) - Understanding the modular codebase.
- [Improvements](Improvements.md) - Planned features and UI enhancements.